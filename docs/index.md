...
| **[▸ FM vs RF — "the arroyo" (RETRACTED)](fm-vs-rf-malpais.html)** | ⚠ **Retracted 2026-08-21.** The "Malpais" fold is the **river-dominated** "Malpais Arroyo–San Juan" HUC12; the LORO scored only the imaged San Juan-valley windows, and the defined reach's **arroyo was never imaged or scored** — so RF 0.557 → FM 0.889 is a hard-*river*-reach number, not an arroyo result. Full post-mortem: **[the reach-provenance gap](2026-08-21-reach-provenance-gap.md)**. (Earlier, narrower catch: [map-extent artifact](2026-08-10-arroyo-map-extent-artifact.md).) |
