...
- [**The beetle didn't break the discriminator — and the control proves we couldn't have seen it if it had**](2026-08-04-phase3c-beetle-null-result.md)
  ...
  prediction (tamarisk-vs-native inverts pre-beetle) is **falsified** — it holds 0.85–0.87 across
  2020→2000 — and the pre-registered Russian-olive control **cratered 0.285**, vetoing the ~0.05 signal
