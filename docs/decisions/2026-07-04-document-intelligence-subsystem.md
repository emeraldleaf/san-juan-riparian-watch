...
(`the private Quartzose repo`) — Haystack 2.0 + Qdrant, a
...
1. **Keep the harness in a separate PRIVATE repo** (revised 2026-07-04b — the harness is a private project
...
3. **Not airgapped → hosted providers.** Drop the prior project's local-vLLM/Ollama-only posture. Use a
