...
| arroyo-rescue-attribution-2026-08-21 | `desert arroyo;arroyo rescue;rescu[a-z]* .{0,15}arroyo` | `attribution to arroyo morphology is unverified;river-dominated subwatershed` | **The "desert arroyo rescue" — that OlmoEarth beat the RF (0.557 → 0.889) because the "Malpais" fold is a distinct DESERT ARROYO morphology the RF was blind to.** Escalates the 2026-08-10 map-extent artifact (which had kept the *metric* valid): the "Malpais" reach is HUC12 140801051001, **"Malpais Arroyo–San Juan" — a river-dominated subwatershed**, not a pure arroyo. On the maps the models sit on the San Juan mainstem while the NMRipMap truth follows the wash, and the LORO scored only the imaged San Juan-valley windows, and the defined reach's northern arroyo was never imaged or scored — so **attribution to arroyo morphology is unverified**, and the 0.557/0.889 gap cannot be attributed to arroyo morphology. Found 2026-08-21 by the project author overlaying imagery/RF/FM/truth. **The whole "arroyo" novelty framing is under review and retracted pending a scoring audit** (are RF and FM scored on comparable extents within the mixed HUC12?). Do not restate "desert arroyo" / "arroyo rescue" until resolved. |
<!-- RETRACTIONS:END -->
