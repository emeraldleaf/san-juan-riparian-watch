...
CAPSTONE="${CAPSTONE:-/Users/joshuadell/Dev/AI Course/my-capstone-rag}"
SRC="$CAPSTONE/production-app/app/backend"
...
if [[ ! -d "$SRC" ]]; then
  ...
  echo "Set CAPSTONE=/path/to/my-capstone-rag and retry." >&2
  exit 1
fi
