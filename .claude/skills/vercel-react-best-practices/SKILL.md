...
> **Vendoring note:** this skill is vendored from
...
>
> **Precedence:** where this skill and CLAUDE.md "Frontend" disagree, **the canon wins** —
> this skill is reference material. See CLAUDE.md.
>
> **Staleness:** this copy is frozen at vendoring time (2026-06-12, ported from NextAurora).
> Re-sync from upstream when starting a major frontend phase, and re-apply this note block
> after syncing.
